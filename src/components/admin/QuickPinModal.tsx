...
export default function QuickPinModal({ ogretmenId, ogretmenAd, ogretmenSoyad, isOpen, onClose, onSuccess }: Props) {
              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    <strong>{ogretmenAd} {ogretmenSoyad}</strong> için PIN oluşturun
                  </p>
