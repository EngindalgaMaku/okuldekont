...
const fieldOptions = [
  ...
  { id: 'pin', label: 'PIN' },
  { id: 'alan', label: 'Alan' },
  { id: 'position', label: 'Görevi' },
  { id: 'active', label: 'Aktif Durumu' },
]

export default function ExportOptionsModal({ isOpen, onClose }: Props) {
  const [isLoading, setIsLoading] = useState(false)
  const [format, setFormat] = useState('default')
  const [selectedFields, setSelectedFields] = useState<string[]>(['name', 'surname', 'alan', 'phone'])
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      const exportFields = format === 'custom' ? selectedFields : 'all'
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
        <h2 className="text-xl font-bold mb-4">Öğretmenleri Dışa Aktar</h2>
        ...
        <div className="space-y-4">
          <div>
            ...
            >
              ...
              <option value="all">Tüm Alanlar (İçe Aktarma Formatı)</option>
          ...
          {format === 'custom' && (
            <div>
              ...
              <div className="mt-2 grid grid-cols-2 gap-2 border p-3 rounded-md">
          ...
          <div>
            ...
            <div className="mt-2 space-y-2">
                <div className="flex items-center">
                    <input id="filter_active" name="filter_active" type="checkbox" className="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500" />
