  ...
  try {
    ...
    return NextResponse.json({
      ...
      currentEducationYear: currentEducationYear
        ? currentEducationYear.year ||
          `${
            currentEducationYear.startDate?.getFullYear() ||
            new Date().getFullYear()
          }-${
            currentEducationYear.endDate?.getFullYear() ||
    ...
    return NextResponse.json({
      ...
      currentEducationYear: `${new Date().getFullYear()}-${
        new Date().getFullYear() + 1
      }`,
      dekontStats: {
        total: 0,
