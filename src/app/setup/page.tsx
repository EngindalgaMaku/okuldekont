...
// Setup sayfası geçici olarak devre dışı - Supabase to Prisma migration tamamlanana kadar
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full mx-4 border-2 border-red-200">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Setup sayfası şu anda Prisma migration nedeniyle devre dışıdır.</p>
