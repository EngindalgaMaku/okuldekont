...
const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "MySQL veritabanı yedekleme araçları",
    icon: Database,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredTools.map((tool) => (
          ...
          >
            {tool.disabled ? (
              <div
                className={`p-6 ${tool.bgColor} opacity-50 cursor-not-allowed`}
              >
              ...
              <Link href={tool.href} className="block">
                <div className={`p-6 ${tool.bgColor} transition-colors`}>
                  ...
                  <div
                    className={`flex items-center ${tool.color} text-sm font-medium`}
                  >
